...
import { userSignIn, adminSignIn, userSignOut, adminSignOut } from "../../actions";
...
export default connect(null, { userSignIn, adminSignIn, userSignOut, adminSignOut })(LoginPage);